...
const Belts = () => {
  const products = [
    {
      id: 1,
      image: "/Women/Accessories/Belts/image1.png",
      originalPrice: 18.59,
      discount: 10,
      finalPrice: 12.23,
    ...
    {
      id: 2,
      image: "/Women/Accessories/Belts/image2.png",
      originalPrice: 8.59,
      discount: 19.0,
      finalPrice: 6.95,
      title: "Regular T-Shirts",
    ...
    {
      id: 3,
      image: "/Women/Accessories/Belts/image3.png",
      originalPrice: 14.59,
      discount: 10,
      finalPrice: 13.13,
    ...
    {
      id: 4,
      image: "/Women/Accessories/Belts/image4.png",
      originalPrice: 21.59,
      discount: 0,
      finalPrice: 21.59,
