...
const HC = () => {
  const products = [
    {
      id: 1,
         image: "/Women/Accessories/CH/image1.png",
      originalPrice: 18.59,
      discount: 10,
      finalPrice: 12.23,
    ...
    {
      id: 2,
         image: "/Women/Accessories/CH/image2.png",
      originalPrice: 8.59,
      discount: 19.0,
      finalPrice: 6.95,
      title: "Regular T-Shirts",
    ...
    {
      id: 3,
         image: "/Women/Accessories/CH/image3.png",
      originalPrice: 14.59,
      discount: 10,
      finalPrice: 13.13,
    ...
    {
      id: 4,
         image: "/Women/Accessories/CH/image4.png",
      originalPrice: 21.59,
      discount: 0,
      finalPrice: 21.59,
    ...
    {
      id: 5,
         image: "/Women/Accessories/CH/image5.png",
      originalPrice: 25.99,
      discount: 15,
      finalPrice: 22.09,
